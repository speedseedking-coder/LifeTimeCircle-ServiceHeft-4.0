...
# Wichtig: SUPERADMIN existiert als Rolle (fÃ¼r High-Risk-Gates)
...
def admin_create_vip_business(
    ...
    with _connect(settings.db_path) as conn:
        ...
        # Insert (idempotent-ish): wenn exists, liefere bestehenden Zustand zurÃ¼ck
