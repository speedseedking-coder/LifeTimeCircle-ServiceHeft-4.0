...
## Arbeitsmodus
- Default: in Repo-Root arbeiten. Wenn Commands gegeben werden, gelten sie für Repo-Root (sonst explizit angegeben).
...
- Hinweis: Export/Redaction/HMAC benötigt LTC_SECRET_KEY (>=16); Tests/DEV setzen ihn explizit.