...
✅ RBAC-Regression abgesichert: `server/tests/test_moderator_block_coverage_runtime.py` (Runtime-Scan über alle registrierten Routes)  
✅ Lokal pytest zeigt **1 Skip**: Blog/News-Check ist bewusst „skipped“, solange `/blog|/news` Routes noch nicht existieren  
...
## RBAC (SoT, serverseitig enforced)
- Default: **deny-by-default**
- **Actor required**: Ohne Actor → **401**
- **Moderator**: strikt nur **Blog/News**; sonst überall **403**
- Enforcement:
  - Router/Endpoints müssen explizit gated sein (Dependencies/Gates)
  - Runtime-Scan-Test stellt sicher, dass Moderator außerhalb Allowlist nicht „durchrutscht“
...
✅ Runtime Dirs vorbereiten: `mkdir -p data` (Runner)  
